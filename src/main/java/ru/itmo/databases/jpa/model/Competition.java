...
public class Competition {   //конкурс
    ...
    public Competition(String title, String label) {
        this.title = title;
        this.label = label;
    }
...
inverseJoinColumns - с другой стороны, про класс, который в списке указан
 ...
 // многие ко многим
//@ManyToMany без дополнительного класса, если необходимо хранить только связь
// класс + @OneToMany и @ManyToOne, если необходимо хранить доп. информацию о связи
 */
